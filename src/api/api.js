...
export const getCaseList = (obj) => request({
	method: 'GET',
	url: '/case/list',
	...createObj(obj)
})

export const getUserInfo = (obj) => request({
	method: 'GET',
	url: '/user/info',
	...createObj(obj)
})

export const getUserPublishList = (obj) => request({
	method: 'GET',
	url: '/user/publish/list',
	...createObj(obj)
})

export const getTest = (obj) => request({
	method: 'GET',
	url: '/test',
	...createObj(obj)
})
